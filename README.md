...
If you want to try it out now, you can visit our interactive demo with the [small data set](https://thdflorianeder.shinyapps.io/netflix_prediction/) or [high accuracy data set](https://thdmoritzenderle.shinyapps.io/netflix_prediction/).
